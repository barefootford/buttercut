...
def main
  ...
  options_parts = []
  options_parts << "sequence_frame_rate: #{sequence_fps}" if sequence_fps
  options_parts << "sequence_width: #{sequence_width}" if sequence_width
  options_parts << "sequence_height: #{sequence_height}" if sequence_height
  options_parts << "windows_file_paths: #{windows_file_paths}"
  options_parts << "audio_track: '#{audio_track}'" if audio_track
  options_part = options_parts.empty? ? "" : ", #{options_parts.join(', ')}"
