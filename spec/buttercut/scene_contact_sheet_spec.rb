require_relative '../../lib/buttercut/scene_contact_sheet'

RSpec.describe SceneContactSheet do
  ...
  describe '.build_ffmpeg_command' do
    ...
    it 'builds correct command for full video' do
      ...
      expect(cmd).to include('-vf', "fps=1/10,scale=#{SceneContactSheet::THUMB_WIDTH}:#{SceneContactSheet::THUMB_HEIGHT},tile=4x3")
