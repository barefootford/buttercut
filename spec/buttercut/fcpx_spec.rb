...
RSpec.describe ButterCut::FCPX do
  ...
  describe '#get_absolute_path' do
    ...
    it 'returns absolute path unchanged' do
      ...
      abs_path = generator.get_absolute_path(absolute)
      expect(abs_path).to eq(absolute)
    end
  end
  ...
  describe '#to_xml' do
    it 'generates valid FCPXML' do
      ...
      expect(xml).to include('<fcpxml version="1.12">')
  ...
  describe '#save' do
    ...
    it 'saves XML to a file' do
      ...
      expect(content).to include('<fcpxml version="1.12">')
    end
